...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/anshnegi10",
      };
  ...
  const projectUrl = `https://anshnegi.com/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — Ansh Negi</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} by Ansh Negi — Cloud Engineer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Ansh Negi`}
        />
        <meta
