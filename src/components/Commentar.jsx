    ...
    useEffect(() => {
        ...
        if (savedComments) {
            try {
                ...
                const pinned = parsed.find(c => c.is_pinned);
                const regular = parsed.filter(c => !c.is_pinned);
    ...
    const handleCommentSubmit = useCallback(async ({ newComment, userName, imageFile }) => {
        ...
        try {
            ...
            setComments(prev => {
                ...
                const allComments = [...updated];
                if (pinnedComment) allComments.push(pinnedComment);
                localStorage.setItem('portfolio_comments', JSON.stringify(allComments));
                return updated;
            });
